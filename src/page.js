                ...
                <div className="col-md-5">
                    <div className='card shadow'>
                        <div className='card-body px-5'>
                            ...
                            <form>
                                <input type='email' className='p-2 mt-4 mb-4 form-control input-bg' placeholder='Phone number,email or username'></input>
                                ...
                                <button type='submit' className='custom-btn custom-btn-white'>
                                    ...
                                    <Link to='/Signup' className='ms-1 text-info'>Sign Up</Link>
                                </button>
                                </div>
                            </form>
                        </div>
